...
const CONDITIONING_STORAGE_KEY = "muscriptor-studio.conditioning";

function loadConditioningSelection(): Set<string> {
  try {
    const saved = window.localStorage.getItem(CONDITIONING_STORAGE_KEY);
...
export function App() {
  ...
  useEffect(() => {
    window.localStorage.setItem(
      CONDITIONING_STORAGE_KEY,
      JSON.stringify(Array.from(condSelected)),
    );
  }, [condSelected]);
